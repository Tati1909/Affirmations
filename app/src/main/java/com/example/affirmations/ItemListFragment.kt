...
import com.example.affirmations.databinding.ItemListFragmentBinding
...
class ItemListFragment : Fragment() {
    ...
    //данные аффирмаций
    private val affirmationData: List<Affirmation> = Datasource().loadAffirmations()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclerView.adapter = Adapter(requireContext(), affirmationData)
